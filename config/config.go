...
func setDefaults(v *viper.Viper) {
	...
	v.SetDefault("datrix.free_login.aes_key", "DATATOM4UAcOR3uLx3bx49kIDdAhaRCAr")
	v.SetDefault("datrix.free_login.signing_key", "skGqMOrcnOcu35Z9APzjfCZuauWQ7BWfIsoEJ1FI")
